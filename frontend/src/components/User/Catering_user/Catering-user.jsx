...
function CateringUser() {
    return (
        <>

            <div className="row photos-head">
                <div className="col-md-4 col-sm-12 main-outlines">
                    <img src="https://media.istockphoto.com/photos/wedding-reception-picture-id160959029?b=1&k=20&m=160959029&s=170667a&w=0&h=WsBHiRFHYC76DlgsuEvKJGbbkNR7Zhbnt32NPylrHNk="
...
const itemData = [
    ...
    {
        img: 'https://media.istockphoto.com/photos/wedding-reception-picture-id160959029?b=1&k=20&m=160959029&s=170667a&w=0&h=WsBHiRFHYC76DlgsuEvKJGbbkNR7Zhbnt32NPylrHNk=',
        title: 'Breakfast',
        rows: 2,
        cols: 2,
    },
    {
        img: 'https://media.istockphoto.com/photos/table-setting-for-an-event-party-or-wedding-reception-picture-id479977238?b=1&k=20&m=479977238&s=170667a&w=0&h=V5aoTjfquc3a-qNBz9hyKJ9bX48XuJW0DVzCaO77U1c=',
